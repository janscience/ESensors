...
https://latex.codecogs.com/svg.image?\large&space;\begin{array}{rcl}&space;E_1&space;&&space;=&space;&&space;\frac{\text{C0DATA}&space;-&space;c_B&space;\cdot&space;\text{C1DATA}}{\tau&space;\cdot&space;g}&space;\cdot&space;\text{GDF}&space;\\&space;&space;E_2&space;&&space;=&space;&&space;\frac{c_C&space;\cdot&space;\text{C0DATA}&space;-&space;c_D&space;\cdot&space;\text{C1DATA}}{\tau&space;\cdot&space;g}&space;\cdot&space;\text{GDF}&space;\\&space;&space;E&space;&&space;=&space;&&space;\max{(E_1,&space;E_2,&space;0)}\end{array}
