# BH1750 and BH1730 ambient light sensor

Senses

- [Light](../parameters/light.md) intensity (illumination)

Warning: this sensor is not produced any more!

A pin but not software compatible version is the
[BH1730](datasheets/bh1730f.pdf).
